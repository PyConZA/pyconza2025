    ...
    def post(self, request, *args, **kwargs):
        if 'resend_email' in request.POST:
            ...
            try:
                ...
                request.session['visa_error'] = "We couldn't find your visa letter request."
            ...
            if letter.status == 'approved':
                ...
                request.session['visa_success'] = "Your request has been received. The team will resend your visa letter shortly."
            else:
                request.session['visa_info'] = f"Your visa letter is still {letter.get_status_display()}. Please wait for it to be approved first."
